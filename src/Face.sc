...
(instance rm71 of Region
	(method (init)
		...
		;(HandsOff)
		;(User canInput: TRUE)
		(User canInput: TRUE canControl: TRUE);allows cursors
		(= str 0)
		(Format @personSaysBuf
			(switch curRoomNum
;;;				(455 {Patti says...}) ;ENGLISH
;;;				(265 {Tawni says...}) ;ENGLISH
;;;				(395 {Bambi says...}) ;ENGLISH
;;;				(325 {Suzi says...}) ;ENGLISH
;;;				(335 {Dale says...}) ;ENGLISH
;;;				(435 {Cherri says...}) ;ENGLISH
;;;				(else  {Carlos says...}) ;ENGLISH
