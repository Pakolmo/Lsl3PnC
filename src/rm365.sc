...
;;;	(Print &rest #at 195 20 #title {Bambi says} #width 115) ;English
	(Print &rest #at 195 20 #title {Bambi dice} #width 115) ;Spanish
	(systemWindow color: vBLACK back: vGREY)
)

(procedure (YouSay)
	(systemWindow color: vLBLUE back: vGREY)
;;;	(Print &rest #at 10 111 #title {You say} #width 150) ;English
	(Print &rest #at 10 111 #title {Dices} #width 150) ;Spanish
	(systemWindow color: vBLACK back: vGREY)
)
