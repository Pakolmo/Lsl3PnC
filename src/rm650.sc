...
(instance RoomScript of Script
	(method (changeState newState)
		(switch (= state newState)
			...
			(18
				(Format @plotString {Versi>n Point and Click Por: DoomLazer y Pakolmo\nAgradecimientos: Kokeween, Benito Camelo y Stormspirit86}) ;Spanish
;;;				(Format @plotString {Version Point and Click By: DoomLazer and Pakolmo\nacknowledgements: Kokeween, Benito Camelo and Stormspirit86}) ;English
				(= seconds (PrintPlot))
			)
			(19
