...
(local
	...
	selected
	status
;;;	okIText = [{Restore} {__Save__} {Replace} {Replace}] English
;;;	textIText = [
...
;;;					]
	...
	el directorio para guardar en un directorio o disco diferente.}
					{Este directorio o disco no puede contener más partidas guardadas. 
	Debes sustituir una de tus partidas guardadas o Cambiar
	el directorio para guardar en un directorio o disco diferente.}
					]					
