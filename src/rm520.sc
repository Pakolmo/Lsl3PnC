...
(instance RoomScript of Script
	...
	(method (handleEvent event)
		...
		(cond 
			...
			(if
				(and ;rock
						(> (event x?) 187) ;x1 (> (mouseX) (left edge of rectangle))
						(< (event x?) 240) ;x2 
						(> (event y?) 71) ;y1
						(< (event y?) 94) ;y2
					)
				...
				(event claimed: FALSE)
								...
								(if
				(and ;area background
						(> (event x?) 120) ;x1 (> (mouseX) (left edge of rectangle))
						(< (event x?) 319) ;x2 
						(> (event y?) 21) ;y1
						(< (event y?) 189) ;y2
					)
					...
					(else
						(event claimed: FALSE)
											...
											(if
				(and ;exitroom right
						(> (event x?) 313) ;x1 (> (mouseX) (left edge of rectangle))
						(< (event x?) 319) ;x2 
						(> (event y?) 97) ;y1
						(< (event y?) 189) ;y2
					)
			...
			(if
				(and ;exitroom down
						(> (event x?) 107) ;x1 (> (mouseX) (left edge of rectangle))
						(< (event x?) 319) ;x2 
						(> (event y?) 176) ;y1
						(< (event y?) 189) ;y2
					)
